...
SetLockStateRequest = _reflection.GeneratedProtocolMessageType(
    "SetLockStateRequest",
    (_message.Message,),
    {
...
SetLockStateReply = _reflection.GeneratedProtocolMessageType(
    "SetLockStateReply",
    (_message.Message,),
    {
...
OpenReply = _reflection.GeneratedProtocolMessageType(
    "OpenReply",
    (_message.Message,),
    {
